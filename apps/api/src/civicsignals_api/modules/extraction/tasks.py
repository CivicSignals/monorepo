...
def run_pending_documents() -> None:
    ...
    Stage 2 of that chain is the relevance gate (doc 19 §3, E8): each document is
    run through ``services.RelevanceClassifier`` first; only those it marks
    relevant (and above the grey-zone threshold) proceed to entity extraction.
    """
